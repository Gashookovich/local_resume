...
const messages = {
  ...
  ru: {
    ...
    history: {
      value: 'Меня зовут Аржанов Вадим, мне 30 лет. Я родился в городе Казань, Республика Татарстан. Сейчас живу в Сербии. Ответственный, энергичный, целеустремлённый, коммуникабельный и просто хороший человек. Не боюсь работы и всегда рад научиться чему-то новому. Здесь вы можете ознакомиться с информацией обо мне и моём опыте работы. На данный момент являюсь frontend-разработчиком. Занимаюсь разработкой сайтов, лэндингов, SPA. Стэк: html, css, JavaScript, TypeScript, React, Redux, Vue, Vuex, Node.js, работа с git, понимание принципов ООП иметодологии БЭМ.'
    },
    education: {
      value: 'Образование'
    },
